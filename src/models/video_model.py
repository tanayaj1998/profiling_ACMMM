...
class DMC(CompressionModel):
    ...
    def compress(self, x, dpb, mv_y_q_scale, y_q_scale):
        ...
        result = {
            ...
            # "mv_enc_dec_time": mv_enc_dec_time,
            "warp_time":warp_time,
    ...
    def decompress(self, dpb, string, height, width,
        ...
        return {
            "dpb": {
                ...
                "ref_y": y_hat,
                "ref_mv_y": mv_y_hat,
                "motion_estimator_time": dpb["motion_estimator_time"],
                "mv_enc_dec_time":dpb["mv_enc_dec_time"],
                "warp_time":dpb["warp_time"]+w_time,
                "main_enc_dec_time": dpb["main_enc_dec_time"],
                "entropy_time": entropy_end,
                "frame_feature_buffer": ff_time,
            },
